...
class TaxonomyWriterSpec extends ObjectBehavior
{
    ...
    function it_creates_new_taxonomy_if_it_does_not_exist(
        $taxonomyRepository, 
        $taxonRepository, 
    ...
    function it_updates_taxonomy_if_it_exists(
        $taxonomyRepository, 
        $taxonRepository, 
        TaxonInterface $taxon, 
        TaxonInterface $root, 
        ...
        $taxonRepository->findOneBy(array('id' => 4))->willReturn($parentTaxon);
        $taxonRepository->findOneBy(array('name' => 'rootName'))->willReturn($root);
        $taxonomyRepository->createNew()->shouldNotBeCalled();
        $taxonRepository->createNew()->willReturn($taxon);
